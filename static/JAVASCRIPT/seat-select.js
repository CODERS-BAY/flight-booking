let takenSeats = []; let selectedSeats = [];let bookedSeats;
let passenger;let chosenSeats = 0;let business;let flight;
let flightID;let depIac;let arrIac;let depAp;let arrAp;
let date;let depTime;let arrTime;let price;
...
$('#paymentButton').on('click', function () {
    ...
    location.href  = "payment.html?depIac=" + depIac + "&arrIac=" + arrIac + "&date=" + date + "&depTime=" + depTime + "&arrTime=" + arrTime + "&price=" + price +
